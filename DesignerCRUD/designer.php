...
if (isset($_POST['submit'])){
    ...
    $sql = " Insert into design_team_details (Designer_id,Name,Email,Contact_number,Skill,Specialisation)
     values('$designerId', '$name1', '$email2', '$contact_number1', '$skills', '$Specialisation1')"; 
